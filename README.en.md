...
| `@wingsky-1/dsh-mem0` | DSH long-term memory system plugin: local/lightweight persistent memory based on mem0, native Git workspace awareness, all-English tool contract, Chinese summary and conflict resolution, and a settings page "Memory Center" for management. | [README](packages/dsh-mem0/README.en.md) | Published (standalone, not in the bundle) |
