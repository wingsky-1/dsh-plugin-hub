...
const EXPECT_FILES: Record<string, string[]> = {
  "dsh-decision-gateway": [
    ...
    "client-dom/pane-helpers.test.ts",
    "client-dom/panes-probability.test.ts",
    "client-dom/tabs-mask-history.test.ts",
    "client-helpers.ts",
    "client-unit/contract-parsers.test.ts",
    "client-unit/format.test.ts",
    "client-unit/history-entry.test.ts",
    ...
    "unit/project-levels.test.ts",
    "unit/put-envelope.test.ts",
    "unit/signal-cancel.test.ts",
    "unit/tool-description.test.ts",
    "unit/tools.test.ts",
  ...
  "dsh-lan-proxy": [
    ...
    "client-unit/client-entry.test.ts",
  ...
  "dsh-mcp-manager": [
    ...
    "unit/unit-catalog-pure.test.ts",
    ...
    "unit/unit-manager-pure.test.ts",
    ...
    "unit/unit-runtime-pure.test.ts",
  ...
  "dsh-notifier": [
    ...
    "unit/shared/file-io-concurrency.test.ts",
    "unit/shared/kinds.test.ts",
    "unit/shared/paths.test.ts",
    "unit/shared/quiet.test.ts",
    ...
    "unit/upgrade/quiet-windows.test.ts",
  ...
  "dsh-provider-usage": [
    ...
    "integration/aggregate/composition-root.test.ts",
    "integration/collect/composition-root.test.ts",
    "integration/data-routes/composition-root.test.ts",
    ...
    "smoke-pure.ts",
    "unit/adapters/unit-adapters-pure.test.ts",
    ...
    "unit/registry/unit-registry-pure.test.ts",
    "unit/report/unit-report-b2-3.test.ts",
    "unit/report/unit-report-executor.test.ts",
    "unit/report/unit-report.test.ts",
    "unit/routes/unit-refactor-pure.test.ts",
    "unit/routes/unit-routes.test.ts",
    "unit/schedule/unit-schedule-pure.test.ts",
    "unit/server-shared/unit-s2-contracts.test.ts",
    "unit/shared/unit-chart.test.ts",
  ...
  "dsh-worktree-sidebar": [
    ...
    "integration/file-io-concurrency.test.ts",
    ...
    "client-unit/inject-keep-mounted.test.ts",
    "unit/scope.test.ts",
    "unit/tools.test.ts",
  ],
};
