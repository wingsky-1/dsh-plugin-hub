...
// （dsh-decision-gateway 的变异面测试清单）。改动请改拓扑后跑 pnpm stryker:gen。
//
...
export default defineConfig({
  test: {
    include: [
      ...
      'packages/dsh-decision-gateway/test/unit/config.test.ts',
      'packages/dsh-decision-gateway/test/unit/custom-presets.test.ts',
      'packages/dsh-decision-gateway/test/unit/decide-contract.test.ts',
      'packages/dsh-decision-gateway/test/unit/history-hardening.test.ts',
      'packages/dsh-decision-gateway/test/unit/history.test.ts',
      ...
      'packages/dsh-decision-gateway/test/unit/project-levels.test.ts',
