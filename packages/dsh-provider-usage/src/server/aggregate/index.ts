...
import { TrendCollector } from "../../domain2/collect/interface.ts";
import { TrendStore } from "./store.ts";
import type { TrendAggRow, TrendDirRow, TrendHourRow } from "../../domain2/collect/interface.ts";
import { safeId } from "../../domain2/collect/interface.ts";
