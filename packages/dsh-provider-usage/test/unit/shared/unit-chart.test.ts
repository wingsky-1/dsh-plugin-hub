 ...
 *
 * 由来：原 unit-v1.test.ts 内的 v2 可迁移断言独立成文件（v1 退役 #932，
 * v1 独有面随符号删除，见本包删除说明）。覆盖：openCodeGoAdapter
 * .formatCapsule/formatPanel、pickWindow、parseUsageResponse、
 * fetchOpenCodeGoV2、miniChartSvgMarkup、safeFetchData/safeFormat/
 * fetchWithTimeout 边界、trendOf/resetTicks 与图表纯函数分档矩阵、
 * #105③ 净化补充。
 */
