/** dsh-jev-decide — 概率条小组件（React；无图表库，手写 div）。 */
...
export function tierBadge(tier: JevHistoryEntry["tier"]): React.ReactElement {
...
export function probPercent(entry: JevHistoryEntry): number {
...
export function ProbBar({ entry }: { readonly entry: JevHistoryEntry }): React.ReactElement {
  const hasConf = entry.confidence !== 0;
