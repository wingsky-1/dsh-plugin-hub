/**
 * dsh-jev-decide — 客户端文案字典（中英双语，零运行时依赖）。
 *
...
export const zh = {
  tabLabel: "JEV 决策",
  cardName: "JEV 决策（dsh-jev-decide）",
  ...
  keyEnv: "ENV 引用",
  keyPlain: "明文密钥",
  modeEnvNote: "当前 ENV 引用：明文侧已置灰禁用。",
  modePlainNote: "当前明文密钥：ENV 侧已置灰禁用。提交明文前请先清空 ENV 输入框。",
  ...
  confirmText: "我确认提交本次明文（仅本次请求，不回显、不入库原文）",
  confirmNeeded: "提交明文前需先勾选二次确认。",
...
export const en: Record<keyof typeof zh, string> = {
  tabLabel: "JEV Decide",
  cardName: "JEV Decide (dsh-jev-decide)",
  ...
  modeEnvNote: "ENV reference active: plaintext side disabled.",
  modePlainNote:
    "Plaintext active: ENV side disabled. Clear the ENV box before submitting plaintext.",
  ...
  confirmText:
    "I confirm submitting plaintext this time (this request only, never echoed or stored)",
  confirmNeeded: "Tick the double-confirm box before submitting plaintext.",
  plainNote:
