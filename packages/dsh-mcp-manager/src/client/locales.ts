...
export const zh = {
  ...
  catalogInjectionLabel: "目录注入时机",
  catalogInjectionAuto: "auto（服务器变化时刷新，默认）",
  catalogInjectionOnce: "once（只在会话开头注入一次）",
  offsetX: "水平偏移",
  offsetY: "垂直偏移",
  blankY: "空白偏移",
  zIndexBase: "层级基准",
...
export const en: Record<McpLocaleKey, string> = {
  ...
  catalogInjectionLabel: "Catalog injection timing",
  catalogInjectionAuto: "auto (refresh when servers change, default)",
  catalogInjectionOnce: "once (inject only at session start)",
