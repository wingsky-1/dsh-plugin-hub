...
- [x] 阶段一：S2/C1/C2/C7（已完成；smoke + contract + pack:check 全通过）
- [x] 阶段二：C3/C4/C5/C6（已完成；同上）
- [ ] 阶段四 4a/4b/4c（未开始：U1/U2/U3/U5/U9/U6/U7/U11）
- [ ] 阶段五：收尾（README/语义文案/全量回归）
- [ ] 专项：U8（方案已评审，按 5.5 修正后实施）
- [ ] 专项：W10（方案已评审，整体后置；C6 的 413 文本截断已随阶段二落地）