...
| `@wingsky-1/dsh-mcp-manager` | MCP server manager (stdio/HTTP; per-working-directory project/global config tiers, all servers collapsed into 4 atomic tools via the middleware) |
