...
export const zh = {
  ...
  // 卡片头/分区/tab
  settingsName: "通知（dsh-notifier）",
  settingsDescription: "审批/完成/错误事件通知 · 事件开关 / 通道 / 合并去重 / 免打扰 / 历史清理",
  secEvents: "通知事件",
  secChannels: "投递频道",
  secDedup: "合并/去重",
  secDnd: "免打扰时段",
...
export const en: Record<NotifierLocaleKey, string> = {
  ...
  settingsName: "Notifier (dsh-notifier)",
  settingsDescription: "Approval/completion/error events · switches / channels / merge & dedup / DND / history",
  secEvents: "Events",
  secChannels: "Delivery channels",
  ...
  routePick: "Pick delivery channels",
