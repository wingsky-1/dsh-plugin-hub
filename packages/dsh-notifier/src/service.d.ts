 ...
 */
export type { NotifierService, NotifyRequest, NotifyResult, NotifySeverity, KindRegistration, NotifyChannel, ChannelCapabilities, NotifySentEvent } from "./service.ts";
...
declare module "@deepseek-ai/cordis" {
  ...
  interface Events {
    "wingsky-notify/sent": (payload: import("./service.ts").NotifySentEvent) => void;
  }
}