...
export default [
  ...
  },
  {
    ...
    // 这条只作用于上面登记的四个文件：装配根本来就要 import 它们，shared/ports.ts 不 import 任何值。
      ...
      "@typescript-eslint/no-restricted-imports": [
        "error",
        {
          paths: [
            {
              name: "./index.ts",
              message: "块不得依赖装配根 index.ts（跨块只走它的装配面）。",
            },
            ...
            {
              name: "./shared/ports.ts",
              allowTypeImports: true,
              message: "shared/ports.ts 是纯类型面：只许 import type。",
            },
          ],
        },
      ],
